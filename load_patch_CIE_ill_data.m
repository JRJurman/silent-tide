...
st_real_XYZ = ref2XYZ(st_real(4:end)', cie.cmf2deg(matching), cie.illD65(matching));
st_real_xyY = XYZ2xyY(st_real_XYZ);

st_imaged_XYZ = ref2XYZ(st_imaged(4:end)', cie.cmf2deg(matching), cie.illD65(matching));
st_imaged_xyY = XYZ2xyY(st_imaged_XYZ);

st_matching_XYZ = ref2XYZ(st_matching(4:end)', cie.cmf2deg(matching), cie.illD65(matching));
...
% convert from refs to XYZ to xyY
tm_real_XYZ = ref2XYZ(tm_real(4:end)', cie.cmf2deg(matching), cie.illD65(matching));
tm_real_xyY = XYZ2xyY(tm_real_XYZ);

tm_imaged_XYZ = ref2XYZ(tm_imaged(4:end)', cie.cmf2deg(matching), cie.illD65(matching));
tm_imaged_xyY = XYZ2xyY(tm_imaged_XYZ);

tm_matching_XYZ = ref2XYZ(tm_matching(4:end)', cie.cmf2deg(matching), cie.illD65(matching));
